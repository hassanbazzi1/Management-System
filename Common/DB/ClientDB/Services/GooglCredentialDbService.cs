...
public class GoogleCredentialDbService : DbFilterService<ClientDbContext,GoogleCredential>
{
    public GoogleCredentialDbService(ClientDbContext context) : base(context)
    {
    }
